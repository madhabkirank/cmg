    ...
    <section id="services" class="service-item">   
	   <div class="container">   
           ...
           <div class="col-md-9 col-sm-12">
					...
					<div class="backcl"><a href="Message_followers#profile">Back</a></div>
...
$DataMessage=$conn->prepare("SELECT * FROM cmg_message WHERE `UMID_from`='".$_SESSION['s-UMID']."' AND category='Followers' AND UMID_to='".$_GET['Message_ID']."'  ");
	...
	?>	<div class="stud_msg">
			...
			<?=ucfirst($dataFETCH_P_G['message_text']);?>
				...
				<div style="padding:5px;">
					    <h3><?=$dataFETCH_TrainerDATA['institute_dname'];?>  <span> <?=$dataFETCH_P_G['time'].' '.$dataFETCH_P_G['date'];?></span></h3>
...
$cmg_messageUP=$conn->prepare("UPDATE `cmg_message` SET `new_status`=1 WHERE `UMID_from`='".$_SESSION['s-UMID']."' AND `UMID_to`='".$_GET['Message_ID']."' AND `from_message`='trainer' AND category='Followers' ");
