...
$DataMessage=$conn->prepare("SELECT * FROM cmg_message WHERE `UMID_to`='".$_SESSION['UMID']."' AND category='General' AND UMID_from='".$_GET['Message_ID']."'  ");
...
$cmg_messageUP=$conn->prepare("UPDATE `cmg_message` SET `new_status`=1 WHERE `UMID_to`='".$_SESSION['UMID']."' AND `UMID_from`='".$_GET['Message_ID']."' AND `from_message`='student' AND category='General' ");
